...
import 'package:flutter_pattern_templates/features/news/data/data_sources/news_network_impl.dart';
import 'package:flutter_pattern_templates/features/news/data/data_sources/news_network.dart';
import 'package:flutter_pattern_templates/features/news/data/repositories/news_repo_impl.dart';
...
import 'package:flutter_pattern_templates/features/notes/data/data_sources/notes_dao_impl.dart';
import 'package:flutter_pattern_templates/features/notes/data/data_sources/notes_dao.dart';
import 'package:flutter_pattern_templates/features/notes/data/repositories/notes_repo_impl.dart';
...
void $initGetIt(GetIt g, {String environment}) {
  ...
  g.registerLazySingleton<NewsNetwork>(() => NewsNetworkImpl(dio: g<Dio>()));
  ...
  g.registerLazySingleton<NotesDao>(
      () => NotesDaoImpl(sembastDB: g<SembastDB>()));
  g.registerLazySingleton<NotesRepo>(
      () => NotesRepoImpl(localSource: g<NotesDao>()));
